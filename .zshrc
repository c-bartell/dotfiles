...
# Load SDKMAN (not managed by brew, see https://sdkman.io):
source "$HOME/.sdkman/bin/sdkman-init.sh"

# Rust stuff
export PATH="$HOME/.cargo/bin:$PATH"

# Use curl managed by Homebrew
export PATH="$(brew --prefix)/opt/curl/bin:$PATH"

# Colorize man pages with bat
# export MANPAGER="sh -c 'col -bx | bat -l man -p'"

# Have less command display colours (adding for man, not sure if this will affect other things)
